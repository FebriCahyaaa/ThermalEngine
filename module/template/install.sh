...
Rom=`getprop ro.product.system.name`
BuildType=`getprop ro.system.build.type`
Time=$(date "+%d, %b - %H:%M %Z")
...
if [ "$BOOTMODE" ] && [ "$KSU" ]; then
  ...
  sleep 0.1
  echo "- SecurityPatch：$SecurityPatch"
  sleep 0.1
  echo "- Rom：$Rom"
  sleep 0.1
...
ui_print "*******************************************************";
ui_print "|              Dynamic Charging Rapidly               |";
ui_print "*******************************************************";
ui_print " "
sleep 1.0
ui_print " "
ui_print " [*] Installizing...  "
sleep 1.5
ui_print " "
ui_print " [*] in the process of installing, wait..!! "
sleep 1.5
